...
datasetPath = 'C:/python_projects/cnn/datasets/sportimages'
destinationModelPath = 'C:/python_projects/cnn/models'
...
riesgo_model.save(os.path.join(destinationModelPath, 'riesgo_3conv.h5'))
